...
namespace ALPAKA_ACCELERATOR_NAMESPACE::lst {
  ...
  public:
    ...
    LSTEvent(bool verbose, const float pt_cut, const uint8_t clussize_cut, Queue& q, const LSTESData<Device>* deviceESData)
        : queue_(q),
          ptCut_(pt_cut),
          clusSizeCut_(clussize_cut),
